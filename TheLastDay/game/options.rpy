...
define config.name = _("Там, где кончается июль")

## Этот файл содержит настройки вашей игры.
...
## Автоматическое масштабирование фонов ######################################
init python:
    def scale_background(img):
        return Transform(img, size=(config.screen_width, config.screen_height))
    
    # Применяем ко всем изображениям с тегом 'bg'
    config.tag_transform['bg'] = scale_background
...
define gui.about = _p("""Интерактивная драма о последних днях династии Романовых. 

Игра основана на исторических документах: дневниках, письмах и воспоминаниях очевидцев.

Вы проживёте 16-17 июля 1918 года вместе с царской семьёй в доме Ипатьева.
Ищите библейские атрибуты, участвуйте в мини-играх, слушайте диалоги.
Финал предопределён, но путь к нему - это дань памяти и уважения.
""")
...
define config.save_directory = "TheLastDay-1772090535"
